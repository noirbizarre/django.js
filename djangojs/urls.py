...
urlpatterns = patterns('',
    ...
    url(r'^tests/1st/(\d+)$', TemplateView.as_view(template_name='djangojs/test/test1.html'), name='first_test'),
    url(r'^tests/2nd/(?P<test>\w+)$', TemplateView.as_view(template_name='djangojs/test/test1.html'), name='second_test'),
