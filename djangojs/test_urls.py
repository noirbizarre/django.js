...
from djangojs.views import TestFormView, JasmineTestView, QUnitTestView

urlpatterns = patterns('',
    url(r'^jasmine$', JasmineTestView.as_view(), name='djangojs_jasmine_runner'),
    url(r'^qunit$', QUnitTestView.as_view(), name='djangojs_qunit_runner'),
